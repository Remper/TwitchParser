package ru.remper.parsers.twitchtv;

import ru.remper.parsers.twitchtv.api.*;
import ru.remper.parsers.twitchtv.api.result.AccessToken;
import ru.remper.parsers.twitchtv.entities.Broadcaster;
import ru.remper.parsers.twitchtv.entities.Stream;
import ru.remper.parsers.twitchtv.stream.IrcWrapper;
...
public class CorpusManager {
     ...
     */
    public Broadcaster recordStream(ru.remper.parsers.twitchtv.api.result.Stream stream) throws Exception {
        if (secretAPI == null) {
