package org.fbk.cit.hlt.parsers.hls.hls;

import org.fbk.cit.hlt.parsers.hls.hls.exceptions.IllegalTagSequence;
import org.fbk.cit.hlt.parsers.hls.hls.tags.TagFactory;
...
public class PlaylistParser {
    ...
    public Playlist parseTwitchMaster(String playlistStr) throws IllegalTagSequence {
        return parse(new org.fbk.cit.hlt.parsers.hls.hls.extensions.twitchtv.MasterPlaylist(), playlistStr);
    }
